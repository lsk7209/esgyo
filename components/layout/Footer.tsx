...
export default function Footer() {
  ...
  return (
    <footer 
      className="border-t bg-gradient-to-b from-gray-50 to-white mt-12 sm:mt-16"
      role="contentinfo"
      aria-label="사이트 푸터"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <nav aria-labelledby="footer-links">
            <h3 id="footer-links" className="font-bold text-lg sm:text-xl mb-4 sm:mb-5 text-gray-900">빠른 링크</h3>
          ...
          <nav aria-labelledby="footer-legal">
            <h3 id="footer-legal" className="font-bold text-lg sm:text-xl mb-4 sm:mb-5 text-gray-900">법적 정보</h3>
            <ul className="space-y-2.5 sm:space-y-3" role="list">
              <li>
          ...
          <section aria-labelledby="footer-contact">
            <h3 id="footer-contact" className="font-bold text-lg sm:text-xl mb-4 sm:mb-5 text-gray-900">문의하기</h3>
