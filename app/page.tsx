    ...
    <PageContainer maxWidth="4xl">
      ...
      <Card className="p-5 sm:p-7 md:p-9 shadow-md hover:shadow-xl transition-all duration-300 border-0 bg-white">
        ...
        <Link href="/calculator/carbon-point" className="block">
          <Button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white text-base sm:text-lg font-semibold py-4 sm:py-5 min-h-[48px] sm:min-h-[52px] rounded-lg shadow-md hover:shadow-lg transition-all duration-200">
            자세히 계산하기 →
          </Button>
        </Link>
      </Card>
