...
export default function PrivacyPage() {
  return (
    <PageContainer maxWidth="4xl">
      <PageHeader
        title="개인정보처리방침"
        description="이에스지요 서비스 개인정보 처리 방침"
      />
      ...
      <Card className="p-8">
        <div className="prose max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700">
              이에스지요는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 
              개인정보를 처리·보유합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">
              이에스지요는 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 
          ...
          <section>
            ...
            <p className="text-gray-700">
              정보주체는 이에스지요에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
            </p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 mt-4">
              <li>개인정보 처리정지 요구</li>
              <li>개인정보 열람 요구</li>
          ...
          <section>
            ...
            <p className="text-gray-700">
              이에스지요는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 
