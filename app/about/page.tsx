  ...
  return (
    <PageContainer maxWidth="4xl">
      ...
      <div className="space-y-8">
        <Card className="p-8">
          <h2 className="text-2xl font-bold mb-4">ESGyo는 무엇인가요?</h2>
        ...
        <Card className="p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-xl font-semibold mb-2">📊 정확한 포인트 계산</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">📖 쉬운 신청 가이드</h3>
              <p className="text-gray-700">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">💡 실용적인 절약 팁</h3>
              <p className="text-gray-700">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2">📝 유용한 정보 공유</h3>
              <p className="text-gray-700">
        ...
        <Card className="p-8 bg-green-50">
          <h2 className="text-2xl font-bold mb-4">면책사항</h2>
