...
export default function CarbonPointCalculatorPage() {
  const {
    tumblerPerWeek,
    receiptPerMonth,
    refillPerMonth,
      ...
      <PageContainer maxWidth="4xl">
        ...
        <div className="mt-5 sm:mt-6 md:mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <Link href="/calculator/transport">
              <Card className="p-4 sm:p-6 hover:shadow-lg transition-shadow cursor-pointer h-full">
                <div className="text-3xl mb-2">🚇</div>
                <h3 className="text-lg sm:text-xl font-bold mb-2">대중교통 vs 자차 비교</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
                  대중교통 이용 시 절약되는 비용과 탄소 감축량을 계산합니다
                </p>
              </Card>
            </Link>
          </div>
